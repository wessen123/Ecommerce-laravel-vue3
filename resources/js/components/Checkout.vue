                        ...
                        <div class="panel panel-info">
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12"><input type="text" v-model="phone" name="phone_number" class="form-control" /></div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12"><strong>Email Address:</strong></div>
                                    <div class="col-md-12"><input type="text" v-model="email" name="email_address" class="form-control" /></div>
                                </div>
                            </div>
                        </div>
                        <!--SHIPPING METHOD END-->
